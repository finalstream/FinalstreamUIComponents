...
{
    public class InputTextContentViewModel : ViewModel
    {
        /* コマンド、プロパティの定義にはそれぞれ 
         * 
        ...
        private Dictionary<string, InputParam> _inputParamDictionary;



        public Dictionary<string, InputParam> InputParamDictionary
        {
